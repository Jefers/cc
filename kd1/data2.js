// data.js – 50+ Keto Protocol (70kg → 64kg, 1400 kcal, SPAR only)
const DEFAULT_DATA = {
  items: [
    ...
    { id: "tuna-can", name: "Tuna in Spring Water (can)", category: "protein", unit: "pcs", quantity: 0 },
    ...
    { id: "pork-scratchings", name: "Pork Scratchings", category: "pantry", unit: "g", quantity: 80 },
  ...
  meals: [
    { id: "chicken-dinner-3", name: "Air Fryer Chicken Thighs (3 pcs)", calories: 750, notes: "Cook 5, eat 3 for dinner, save 2 for breakfast", ingredients: [{ itemId: "chicken-thigh", name: "Chicken Thigh (skin-on, bone-in)", quantity: 3, unit: "pcs" }] },
    ...
    { id: "ribeye-garlic-butter", name: "Ribeye Steak with Garlic Butter", calories: 800, notes: "250g raw ribeye + 20g butter", ingredients: [{ itemId: "ribeye-steak", name: "Ribeye Steak", quantity: 250, unit: "g" }, { itemId: "golden-cow-butter", name: "Golden Cow Salted Butter", quantity: 20, unit: "g" }] },
    { id: "snack-brie-ham", name: "Brie & Ham Snack", calories: 175, notes: "30g brie + 2 slices ham (approx 50g)", ingredients: [{ itemId: "french-brie", name: "French Brie 60%", quantity: 30, unit: "g" }, { itemId: "cooked-ham", name: "Cooked Ham (no glaze)", quantity: 50, unit: "g" }] },
    { id: "snack-pork-scratchings", name: "Pork Scratchings (20g)", calories: 110, ingredients: [{ itemId: "pork-scratchings", name: "Pork Scratchings", quantity: 20, unit: "g" }] },
    { id: "snack-brie-only", name: "Brie (30g)", calories: 100, ingredients: [{ itemId: "french-brie", name: "French Brie 60%", quantity: 30, unit: "g" }] },
    { id: "leftover-mince", name: "Leftover Beef Mince", calories: 390, notes: "~150g cooked mince", ingredients: [{ itemId: "beef-mince", name: "Beef Mince 20% Fat", quantity: 150, unit: "g" }] },
    { id: "leftover-ribeye", name: "Leftover Ribeye Slices", calories: 280, notes: "~100g cooked steak", ingredients: [{ itemId: "ribeye-steak", name: "Ribeye Steak", quantity: 100, unit: "g" }] },
    { id: "greek-yogurt-plain", name: "Greek Yogurt (200g)", calories: 230, ingredients: [{ itemId: "greek-yogurt", name: "Greek Style Yogurt 5% Fat", quantity: 200, unit: "g" }] },
    { id: "sauerkraut-side", name: "Sauerkraut Side (50g)", calories: 10, ingredients: [{ itemId: "sauerkraut", name: "Sauerkraut", quantity: 50, unit: "g" }] },
    { id: "coffee-cream", name: "Coffee with Double Cream", calories: 100, notes: "2 tbsp (30ml) cream", ingredients: [{ itemId: "double-cream", name: "Double Cream", quantity: 30, unit: "ml" }] },
    { id: "tuna-bridge", name: "Tuna Protein Bridge", calories: 100, notes: "Optional – helps hit 140g protein", ingredients: [{ itemId: "tuna-can", name: "Tuna in Spring Water (can)", quantity: 1, unit: "pcs" }] }
  ],
  plan: [
  ...
  supplements: [
    ...
    { id: "potassium-citrate", name: "Potassium Citrate", dosage: "200–400 mg with dinner", reason: "Prevents electrolyte imbalance (cramps, fatigue) on low‑carb diet.", priority: "essential" },
    { id: "sodium", name: "Pink Himalayan Salt", dosage: "¼ tsp in water AM + liberally on food", reason: "Critical for energy and avoiding 'keto flu'.", priority: "essential" },
    { id: "vitamin-d3-k2", name: "Vitamin D3 + K2", dosage: "5,000 IU D3 / 100 mcg K2 daily", reason: "Supports insulin sensitivity, bone health, and testosterone.", priority: "optional" }
  ],
  notes: {
    nutritionalStatus: [
